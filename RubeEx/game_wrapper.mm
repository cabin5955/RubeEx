...
void CommonInit(){
    ...
    ResourceManager::LoadShader(Global::ResFullPath(vs,"rube.vs"),Global::ResFullPath(fs,"sprite.fs"),
                                nullptr, "rube");
...
- (void)InitWidth:(GLfloat) width Height:(GLfloat) height{
    ...
    GameB2Rube::GetInstance()->Init(width, height);
    Director::GetInstance()->SetRootScene(GameB2Rube::GetInstance());
